...
const Videos = () => {
  ...
  useEffect(() => {
    ...
    // CHANGED: Simplified greeting - always show "Hello" instead of time-based greetings
    setGreeting("Hello");
  }, [dispatch]);
  useEffect(() => {}, []);
  ...
  const handleCategoryClick = (categoryTitle) => {
    const encodedCategoryName = encodeURIComponent(categoryTitle);
    history.push(`/category/${encodedCategoryName}`);
  };
            ...
            <div className="home-upload-container">
              ...
              {user ? (
                <div className="home-settings">
                  ...
                  >
                    <Link to="/my-videos" className="home-settings-link">
                      <FaVideo /> My Videos
                    </Link>
                  </div>{" "}
                  <br />
                ...
                >
                  {banner?.map((ban, index) => (
                    <div key={index} className="home-banner">
                      ...
                      <Link to={ban.link} className="legend">
                        SHOW
                      </Link>
                    </div>
                  ))}
